...
public class Message implements java.io.Serializable{ 
	...
	public String toString() {
		return SpringUtils.getMessage(msg);
	}
	
	public static void main(String[] args) {
		System.out.println("hello word");
		ApplicationContext factory=new ClassPathXmlApplicationContext("classpath:config/applicationContext.xml");
		System.out.println(SpringUtils.getMessage("success", "yyy"));
	}
