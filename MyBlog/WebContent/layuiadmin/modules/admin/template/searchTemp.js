  ...
  $('button').on('click',function(){
  	...
  	if(!'submit' == type){
  		layer.open({
  			...
  			/* ,area: ['420px', '400px'] */
  			,btn: ['确定', '取消']
  			,content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;"><div class="layui-form-item">label class="layui-form-label">提示值</label><div class="layui-input-block"><input type="text" name="text" required  lay-verify="required" placeholder="输入框的名称" autocomplete="off" class="layui-input"></div></div></div>'
