...
function(e) {console.log("tree ");
    ...
    m.prototype.tree = function(e, data_) {console.log("tree.tree");//渲染 不管是初始渲染还是新增元素的渲染都会调用此
        ...
        layui.each(data, function(a, itemData) {
            ...
            that.spread(o, itemData),								//绑定对应的事件
            config.showCheckbox && that.checkClick(o, itemData), 	//绑定对应的事件
    ...
    m.prototype.checkClick = function(e, n) {console.log("tree.checkClick");// 选中 回调oncheck方法
        var r = this,
        l = r.config,
        t = e.children("." + o),
        d = t.children("." + u),
