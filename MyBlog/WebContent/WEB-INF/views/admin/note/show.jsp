...
<head>
  ...
  * {
  ...
  .more-oprate li > i, .more-oprate li > .layui-icon{
	...
	.code_box .iframe_div{height:30px;width:100%;border-bottom:1px solid #ccc; background:rgba(85, 85, 85, 0.15)}
	...
	.code_box .code{overflow:hidden; max-height:700px; overflow-y:auto; overflow-x:auto; width:100%; }
	...
	.code_box{margin-top:10px; width:100%; border:1px solid #ddd; border-radius:5px; padding:5px; font-size:12px; font-family:Consolas; overflow:hidden;}
