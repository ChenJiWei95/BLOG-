...
<head>
	...
	.simp-async-page-btn{    
		cursor:pointer; background: #555; border-radius: 5px; margin-left: 10px; margin-right: 10px;border: 1px solid #fff; text-align: center; line-height: 30px;
    }
	</style>
</head>
<body>
	...
	<div class="layui-row layui-col-space10">
		...
		<div class="layui-col-md5">
			<div class="layui-card content">
				...
				<my:async-simple-page pageIndex="0" pageSize="12" styleClass="simp-async-page-btn" action="list"/>
				<my:simple-page pageIndex="0" pageSize="12" styleClass="simp-async-page-btn" action="test.chtml"/>
			</div>
		</div>
...
var token = top.token;
    ...
    }).use(['index', 'searchTemp', 'cutil', 'admin'],function(){
    	var cutil = layui.cutil
    	,layer = layui.layer
    	,admin = layui.admin;
    	cutil.simpleAsyncPageBtn({
    		/* data: {id: 125}
    		,method: 'list'
